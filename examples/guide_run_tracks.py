...
def parse_args(args):
  ...
  parser = argparse.ArgumentParser(
    description="Example of running Tracks via Koshee Protect REST API",
    add_help=True
  )
  ...
  parser.add_argument('--cf', '--config', action='store',
    dest='config', help='the track config to run',
...
################################################################
# Step 2: run tracks with the provided config option
################################################################
